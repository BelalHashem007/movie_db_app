...
export default function Header() {
  ...
  return (
    <header className="h-20 shrink-0 flex  items-center bg-white border-b border-b-gray-200 dark:bg-gray-900 dark:border-gray-800  gap-5 justify-around">
      ...
      <nav>
        <ul className="flex gap-5 items-center">
          ...
          <li>
            <Link to="signup" className="bg-red-600 text-white hover:cursor-pointer hover:bg-red-700 px-4 py-2 rounded-lg">
                Signup
            </Link>
          </li>
        </ul>
